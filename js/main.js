...
function init() {
    document.getElementById('pageTitle').innerHTML = CONFIG.pageTitle
    $('#title').text(CONFIG.title).css('color', 'black');
    $('#desc').text(CONFIG.desc)
    $('#yes').text(CONFIG.yesBtn)
    $('#no').text(CONFIG.noBtn)
...
function moveButton() {
    var audio = new Audio('audio/nopenotlettingthathappen.mp3');
    audio.play();
...
$('#yes').click(function() {
    Swal.fire({
        ...
        width: 900,
        padding: '3em',
        html: "<input type='text' class='form-control' id='txtReason' onmousemove=textGenerate()  placeholder='I love u '>",
